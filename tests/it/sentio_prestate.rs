...
use revm_inspectors::tracing::{
    SentioPrestateTraceBuilder, TracingInspector, TracingInspectorConfig,
};
...
fn test_sentio_prestate_tracer_logs() {
    ...
    */
    ...
    let prestate_tracer_config = SentioPrestateTracerConfig { diff_mode: true };
...
fn test_sentio_prestate_tracer_weth_transfer() {
    ...
    db.insert_account_info(user1, AccountInfo { balance: init_balance, ..Default::default() });
    let cfg = CfgEnvWithHandlerCfg::new(CfgEnv::default(), HandlerCfg::new(SpecId::LONDON));
    ...
    let slot =
        B256::from_slice(&hex!("b0f566e5e54ad5f271b39da0d24b21fd2c693a146cc0643b02f3481c94580329"));
